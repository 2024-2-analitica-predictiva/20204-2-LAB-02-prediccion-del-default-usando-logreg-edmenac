...
# ------------------------------------------------------------------------------
# MODEL_FILENAME = r"C:/Users/edmc9/Documents/GitHub/Especializacion_Analitica/Analitica_predictiva/20204-2-LAB-02-prediccion-del-default-usando-logreg-edmenac/files/models/model.pkl"
...
def _load_grading_data():
    """Load grading data"""
    # with open(r"C:/Users/edmc9/Documents/GitHub/Especializacion_Analitica/Analitica_predictiva/20204-2-LAB-02-prediccion-del-default-usando-logreg-edmenac/files/grading/x_train.pkl", "rb") as file:
    with open("files/grading/x_train.pkl", "rb") as file:
        x_train = pickle.load(file)

    # with open(r"C:/Users/edmc9/Documents/GitHub/Especializacion_Analitica/Analitica_predictiva/20204-2-LAB-02-prediccion-del-default-usando-logreg-edmenac/files/grading/y_train.pkl", "rb") as file:
    with open("files/grading/y_train.pkl", "rb") as file:
        y_train = pickle.load(file)

    # with open(r"C:/Users/edmc9/Documents/GitHub/Especializacion_Analitica/Analitica_predictiva/20204-2-LAB-02-prediccion-del-default-usando-logreg-edmenac/files/grading/x_test.pkl", "rb") as file:
    with open("files/grading/x_test.pkl", "rb") as file:
        x_test = pickle.load(file)

    # with open(r"C:/Users/edmc9/Documents/GitHub/Especializacion_Analitica/Analitica_predictiva/20204-2-LAB-02-prediccion-del-default-usando-logreg-edmenac/files/grading/y_test.pkl", "rb") as file:
...
def _load_metrics():
    # assert os.path.exists(r"C:/Users/edmc9/Documents/GitHub/Especializacion_Analitica/Analitica_predictiva/20204-2-LAB-02-prediccion-del-default-usando-logreg-edmenac/files/output/metrics.json")
    assert os.path.exists("files/output/metrics.json")
    # metrics = []
    # with open(r"C:/Users/edmc9/Documents/GitHub/Especializacion_Analitica/Analitica_predictiva/20204-2-LAB-02-prediccion-del-default-usando-logreg-edmenac/files/output/metrics.json", "r", encoding="utf-8") as file:
...
def _test_metrics(metrics):
    ...
    for index in [0, 1]:
        ...
        assert (
            metrics[index]["balanced_accuracy"] >= METRICS[index]["balanced_accuracy"]
        )
